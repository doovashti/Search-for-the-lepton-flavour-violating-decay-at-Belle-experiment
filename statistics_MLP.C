...
FLoat_t br_RhotoPi0Pim = 1; // We have assumed to be 100%
FLoat_t br_Pi0toPhotons = 0.988; // close to 100%
Float_t sigtheory = round(nBBbar * br_BtoKTauMu * br_TautoRho * br_RhotoPi0Pim * br_Pi0toPhotons); // actual signal events expected at belle


//////////////////////////Uploading files//////////////////////////////////////////

TFile *f_sig_original = new TFile("MC_data/MLP_bbar/MLP_signalmc_taum_mup_tightcuts.root");
TTree *t_sig = (TTree*)f_sig_original->Get("incl");

TChain *c_bkg = new TChain("incl");

c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_0.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_1.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_2.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_3.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_4.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_uds_5.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_0.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_1.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_2.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_3.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_4.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charm_5.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_0.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_1.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_2.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_3.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_4.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_5.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_6.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_7.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_8.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_charged_9.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_0.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_1.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_2.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_3.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_4.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_5.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_6.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_7.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_8.root");
c_bkg->Add("MC_data/MLP_bbar/MLP_bkg_mixed_9.root");
...
//////////////////////////////////////MLP CONTINUUM//////////////////////////////////////////////////
TCut continuum_cut = "MLP_continuum > 0.28";
...
////////////////////////////MLP BBAR/////////////////////////////////////
TCut bbar_cut = "MLP_continuum > 0.09";
