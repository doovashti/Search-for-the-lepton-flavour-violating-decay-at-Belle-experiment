...
t_sig->SetBranchAddress("bdt_continuum", &sig_bdts);
...
c_bkg_charm->SetBranchAddress("bdt_continuum", &bkg_bdts_charm);
...
c_bkg_uds->SetBranchAddress("bdt_continuum", &bkg_bdts_uds);
...
TCanvas *c1 = new TCanvas("c1", "Punzi FOM vs BDT Cut", 1024, 786);
...
std::cout << "The optimal cut for the BDT score is: " << cut_max << std::endl;
